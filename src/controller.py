...
class Controller:
    ...
    def make_new_transaction(self):
        ...
        self.select_sim() if self.select_device() else None
        self.select_case()
        self.select_charger()

        self.__order.cart = self.__transaction
        self.display_transaction_items()
        if self.allow_discount():
            ...
            self.display_transaction_total(discount)
        else:
            self.display_transaction_total()
    ...
    def select_device(self) -> int:
        ...
        self.select_an_item(devices, "device_type")
        return 1 if device == "Phone" else 0

    def select_sim(self) -> None:
        ...
        self.select_an_item(devices, "sim")
    ...
    def select_case(self) -> None:
        ...
        # 3 - Proceed to standard selection
        self.select_an_item(devices, "case")

    def select_charger(self) -> None:
        # 1 - Display "Which one do you want?"
        ...
        self.select_an_item(devices, "chargers")

    def select_an_item(self, devices: List[Item], transaction_attribute: str) -> None:
    ...
    def display_transaction_total(self, discount: float = 0.0) -> None:
        self.__view.display_transaction_sub_total(self.__transaction, discount)

    def display_transaction_items(self) -> None:
        self.__view.display_transaction_items(self.__transaction)

    def allow_discount(self) -> bool:
